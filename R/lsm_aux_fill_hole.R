...
lsm_aux_fill_hole <- function(input,
    ...
    if(zero_as_null){
        ...
        rgrass::execGRASS(cmd = "r.mapcalc",
                          ...
                          expression = paste0(input, output, "_aux_fill_hole_null = ",
                                              input))
        ...
        rgrass::execGRASS(cmd = "r.mapcalc",
                          flags = c("overwrite", "quiet"),
                          expression = paste0(input, output, "_aux_fill_hole_binary = if(isnull(",
                                              input, "), 0, 1)"))
        ...
        rgrass::execGRASS(cmd = "r.mapcalc", flags = c("overwrite", "quiet"),
                          expression = paste0(input, output, "_aux_fill_hole_null = if(",
                                              input, " == 1, 1, null())"))

        # binary
        rgrass::execGRASS(cmd = "r.mapcalc", flags = c("overwrite", "quiet"),
                          expression = paste0(input, output, "_aux_fill_hole_binary = ",
                                              input))
    ...
    rgrass::execGRASS(cmd = "r.clump",
                      ...
                      input = paste0(input, output, "_aux_fill_hole_null"),
    ...
    rgrass::execGRASS(cmd = "r.mapcalc",
                      flags = c("overwrite", "quiet"),
                      expression = paste0(input, output, "_aux_fill_hole_matrix = if(isnull(",
                                          input, output, "_aux_fill_hole_null), 1, 0)"))

    # fill hole ----
    rgrass::execGRASS(cmd = "g.message", message = "Filling holes")
    rgrass::execGRASS(cmd = "r.mapcalc",
                      flags = c("overwrite", "quiet"),
                      expression = paste0(input, output, "_aux_fill_hole_matrix_null = if(",
                                          input, output, "_aux_fill_hole_matrix == 1, 1, null())"))
    ...
    rgrass::execGRASS(cmd = "r.neighbors",
                      ...
                      selection = paste0(input, output, "_aux_fill_hole_binary"),
    ...
    readr::read_csv(paste0(input, output, "_aux_fill_hole.txt"),
                    show_col_types = FALSE, col_names = c("id", "n_ids")) %>%
        dplyr::count(id) %>%
        readr::write_delim(paste0(input, output, "_aux_fill_hole.txt"),
    ...
    rgrass::execGRASS(cmd = "r.mapcalc",
                      flags = c("overwrite", "quiet"),
                      expression = paste0(input, output, "_aux_fill_hole_matrix_fill = ",
                                          input, output, "_aux_fill_hole_matrix_id_fill == 1"))

    rgrass::execGRASS(cmd = "r.mapcalc",
                      flags = c("overwrite", "quiet"),
                      expression = paste0(input, output, "_aux_fill_hole_matrix_fill = if(isnull(",
                                          input, output, "_aux_fill_hole_matrix_fill), 0, ",
                                          input, output, "_aux_fill_hole_matrix_fill)"))

    rgrass::execGRASS(cmd = "r.mapcalc",
                      flags = c("overwrite", "quiet"),
                      expression = paste0(input, output, "_aux_fill_hole = ",
                                          input, output, "_aux_fill_hole_binary + ",
                                          input, output, "_aux_fill_hole_matrix_fill"))
    ...
    if(zero_as_null){
        ...
        rgrass::execGRASS(cmd = "r.mapcalc",
                          flags = c("overwrite", "quiet"),
                          expression = paste0(input, output, "_aux_fill_hole = if(",
                                              input, output, "_aux_fill_hole_binary == 0, null(), 1)"))
    ...
    suppressWarnings(
        rgrass::execGRASS(cmd = "g.remove",
                          flags = c("b", "f", "quiet"),
                          type = "raster",
                          name = c(paste0(input, output, "_aux_fill_hole_null"),
                                   paste0(input, output, "_aux_fill_hole_binary"),
